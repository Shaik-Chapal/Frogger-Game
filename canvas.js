...
const start_local = new Background(0, canvas.height - frog_size_y, canvas.width, frog_size_y, 'yellow')
...
function updateScreen() {
    ...
    if (live < 0 ) {
        c.font = "20px Georgia"
        c.fillStyle="white"
        c.fillText("Game is over! try again !!!", canvas.width / 4, canvas.height / 2 - 10)
        c.fillText("Press any button to continue.......", 20, canvas.height /2 +frog_size_y -10)
        console.log("Live <0")
        window.cancelAnimationFrame(updateScreen)
        PressAnyKey()
